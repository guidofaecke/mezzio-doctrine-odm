...
{
    /** @internal */
    public function __construct(private string $configKey = 'odm_default')
    {
    }
     ...
     *
     * In case you want to use another config key than "odm_default", you can add the following factory to your config:
     *
     * <code>
     * <?php
     * return [
     *     'doctrine.SECTION.odm_other' => [SpecificFactory::class, 'odm_other'],
     * ];
     * </code>
     *
